...
export const InteractiveCausalChain: React.FC<InteractiveCausalChainProps> = ({
  ...
  const steps = [
    ...
    },
    {
      ...
      proof: {
        headline: 'Cross-Domain Subscriber Registration Blast Radius',
    ...
    },
    {
      ...
      proof: {
        headline: 'Financial Revenue Exposure & ARPU Quantification',
        baseline: 'Nominal Churn-Weighted Exposure: 0 DZD (Within SLA Tolerances)',
        degraded: 'Active Revenue at Risk: 12,500 DZD / Month (Potential 150,000 DZD Annual Churn)',
    ...
    },
    {
      ...
      color: 'border-emerald-500/40 text-emerald-400',
      proof: {
        headline: 'Bidirectional Enterprise ITSM Ticket Synchronization',
        baseline: 'No Enterprise System Sync',
        degraded: 'ServiceNow Work Order INC-SNOW-89421 created & assigned to RAN_ENGINEERING_TIER_2',
        formula: 'JSON eTOM/ITIL Payload: { ticket_id, priority: "P1", blast_radius: 1284, root_cause, sync_state: "ASSIGNED" }',
        pills: ['Connector: ServiceNow Table API', 'Status: ASSIGNED / IN_PROGRESS', 'Work Notes: Auto-Populated with AI Proof'],
